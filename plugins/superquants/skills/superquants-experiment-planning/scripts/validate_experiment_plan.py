#!/usr/bin/env python3
"""Validate that a Experiment plan contains the required sections."""
...
def main() -> int:
    ...
    if missing:
        print(f'Experiment plan is missing required sections in {path}:')
        for heading in missing:
            print(f'- {heading}')
        return 1

    print(f'Experiment plan looks complete: {path}')
    return 0
