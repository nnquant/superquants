#!/usr/bin/env python3
"""Create a data audit from the bundled template."""
...
def main() -> int:
    ...
    output_path = audits_dir / f'{args.date}-{slug}-data-audit.md'
    write_text_file(output_path, render_template('data-audit-template.md', replacements), force=args.force)

    print(f'Created data audit: {output_path}')
    return 0
