#!/usr/bin/env python3
"""Validate that a Data audit contains the required sections."""
...
def main() -> int:
    ...
    if missing:
        print(f'Data audit is missing required sections in {path}:')
        for heading in missing:
            print(f'- {heading}')
        return 1

    print(f'Data audit looks complete: {path}')
    return 0
