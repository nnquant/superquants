#!/usr/bin/env python3
"""Create an operator runbook from the bundled template."""
...
def main() -> int:
    ...
    output_path = production_dir / f'{args.date}-{slug}-runbook.md'
    write_text_file(output_path, render_template('runbook-template.md', replacements), force=args.force)

    print(f'Created runbook: {output_path}')
    return 0
