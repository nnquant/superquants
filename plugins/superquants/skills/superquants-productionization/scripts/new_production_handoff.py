#!/usr/bin/env python3
"""Create a production handoff from the bundled template."""
...
def main() -> int:
    ...
    production_dir = root / 'research' / 'superquants' / 'production'
    ...
    output_path = production_dir / f'{args.date}-{slug}-production-handoff.md'
    write_text_file(output_path, render_template('production-handoff-template.md', replacements), force=args.force)

    print(f'Created production handoff: {output_path}')
    return 0
