#!/usr/bin/env python3
"""Create a research spec from the bundled template."""
...
def main() -> int:
    ...
    output_path = specs_dir / f'{args.date}-{slug}-research-spec.md'
    write_text_file(output_path, render_template('research-spec-template.md', replacements), force=args.force)

    print(f'Created research spec: {output_path}')
    return 0
