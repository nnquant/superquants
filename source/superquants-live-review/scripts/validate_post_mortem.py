#!/usr/bin/env python3
"""Validate that a Post-mortem contains the required sections."""
...
def main() -> int:
    ...
    if missing:
        print(f'Post-mortem is missing required sections in {path}:')
        for heading in missing:
            print(f'- {heading}')
        return 1

    print(f'Post-mortem looks complete: {path}')
    return 0
