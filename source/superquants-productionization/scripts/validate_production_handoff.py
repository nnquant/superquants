#!/usr/bin/env python3
"""Validate that a Production handoff contains the required sections."""
...
def main() -> int:
    ...
    if missing:
        print(f'Production handoff is missing required sections in {path}:')
        for heading in missing:
            print(f'- {heading}')
        return 1

    print(f'Production handoff looks complete: {path}')
    return 0
