#!/usr/bin/env python3
"""Create a review memo from the bundled template."""
...
def main() -> int:
    ...
    output_path = reviews_dir / f'{args.date}-{slug}-review-memo.md'
    write_text_file(output_path, render_template('review-memo-template.md', replacements), force=args.force)

    print(f'Created review memo: {output_path}')
    return 0
