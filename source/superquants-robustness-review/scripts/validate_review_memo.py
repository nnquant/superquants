#!/usr/bin/env python3
"""Validate that a Review memo contains the required sections."""
...
def main() -> int:
    ...
    if missing:
        print(f'Review memo is missing required sections in {path}:')
        for heading in missing:
            print(f'- {heading}')
        return 1

    print(f'Review memo looks complete: {path}')
    return 0
