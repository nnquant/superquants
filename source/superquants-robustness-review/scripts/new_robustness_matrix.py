#!/usr/bin/env python3
"""Create a robustness matrix from the bundled template."""
...
def main() -> int:
    ...
    reviews_dir = root / 'research' / 'superquants' / 'reviews'
    ...
    output_path = reviews_dir / f'{args.date}-{slug}-robustness-matrix.md'
    write_text_file(output_path, render_template('robustness-matrix-template.md', replacements), force=args.force)

    print(f'Created robustness matrix: {output_path}')
    return 0
