#!/usr/bin/env python3
"""Validate that a Research spec contains the required sections."""
...
def main() -> int:
    ...
    if missing:
        print(f'Research spec is missing required sections in {path}:')
        for heading in missing:
            print(f'- {heading}')
        return 1

    print(f'Research spec looks complete: {path}')
    return 0
