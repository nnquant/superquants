#!/usr/bin/env python3
"""Create a compact research brief from the bundled template."""
...
def main() -> int:
    ...
    output_path = specs_dir / f'{args.date}-{slug}-research-brief.md'
    write_text_file(output_path, render_template('research-brief-template.md', replacements), force=args.force)
    print(f'Created research brief: {output_path}')
    return 0
