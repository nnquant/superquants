#!/usr/bin/env python3
"""Validate that a Experiment log contains the required sections."""
...
def main() -> int:
    ...
    if missing:
        print(f'Experiment log is missing required sections in {path}:')
        for heading in missing:
            print(f'- {heading}')
        return 1

    print(f'Experiment log looks complete: {path}')
    return 0
