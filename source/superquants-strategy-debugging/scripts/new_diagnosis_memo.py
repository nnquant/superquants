#!/usr/bin/env python3
"""Create a diagnosis memo from the bundled template."""
...
def main() -> int:
    ...
    output_path = diagnoses_dir / f'{args.date}-{slug}-diagnosis-memo.md'
    write_text_file(output_path, render_template('diagnosis-memo-template.md', replacements), force=args.force)

    print(f'Created diagnosis memo: {output_path}')
    return 0
